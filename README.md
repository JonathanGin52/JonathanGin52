...
![](https://img.shields.io/badge/Moves%20played-4840-blue)
![](https://img.shields.io/badge/Completed%20games-275-brightgreen)
![](https://img.shields.io/badge/Total%20players-882-orange)

Everyone is welcome to participate! To make a move, click on the **column number** you wish to drop your disk in.

It is the **red** team's turn to play.

|1|2|3|4|5|6|[7](https://github.com/JonathanGin52/JonathanGin52/issues/new?title=connect4%7Cdrop%7Cred%7C7&body=Just+push+%27Submit+new+issue%27+without+editing+the+title.+The+README+will+be+updated+after+approximately+30+seconds.)|
| - | - | - | - | - | - | - |
